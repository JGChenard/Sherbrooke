...
# download 'https://github.com/TahiriNadia/IFT870/blob/main/iris.txt'
...
plt.xlabel('x_2')
plt.ylabel('quantity')
plt.title('Distribution dataset IRIS')

# Ex 23
plt.scatter(iris[:,2], iris[:,3])
plt.xlabel('x_3')
plt.ylabel('x_4')
plt.title('Nuage de points dataset IRIS')

# Ex 24
plt.scatter(iris[:, 2], iris[:, 3], c=iris[:, -1])
plt.xlabel('x_3')
plt.ylabel('x_4')
plt.title('Nuage de points dataset IRIS (avec couleur)')
